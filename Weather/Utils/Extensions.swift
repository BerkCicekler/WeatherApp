...
extension Color {
    ...
    static let tabBarBorderApp = Color("Tab Bar Border").opacity(0.5)
    static let forecastCardBackgroundApp = Color("Forecast Card Background")
    static let probabilityTextApp = Color("Probability Text")
}
